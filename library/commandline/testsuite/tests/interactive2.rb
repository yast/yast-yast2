...
#
# ***************************************************************************
# File:	interactive2.ycp
# Package:	yast2
# Summary:	test "exit" in interactive mode
...
module Yast
  class Interactive2Client < Client
    def main
      ...
      TEST(lambda { CommandLine.Command }, [{ "dev" => { "tty" => "exit" } }], nil)
      TEST(lambda { CommandLine.Done }, [], nil)
...
Yast::Interactive2Client.new.main
