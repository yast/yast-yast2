...
# File:	command6.ycp
# Package:	yast2
# Summary:	test command-line parsing for non-strict actions
...
module Yast
  class Command7Client < Client
    def main
      ...
      TEST(->() { CommandLine.Init(@cmdline, ["list", "eth0", "configured=1"]) }, [], nil)
