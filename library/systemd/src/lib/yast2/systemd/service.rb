...
module Yast2
  module Systemd
    ...
    class Service < Unit
      ...
      SERVICE_PROPMAP = Systemd::Unit::DEFAULT_PROPMAP.merge(triggered_by: "TriggeredBy")
      ...
      class << self
        ...
        def find_many_at_once(service_names, propmap = {})
          ...
          snames.zip(property_texts).map do |service_name, property_text|
            service = new(service_name, service_propmap, property_text)
