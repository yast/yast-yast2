...
module SimpleIDN
  ...
  TRANSITIONAL = ::T.let(nil, ::T.untyped)
  UTS64MAPPING = ::T.let(nil, ::T.untyped)
  VERSION = ::T.let(nil, ::T.untyped)
end
...
module Yast::HwinfoClassnamesInclude
  extend ::T::Sig
end
...
module Yast::WizardSequencerInclude
  extend ::T::Sig
end
